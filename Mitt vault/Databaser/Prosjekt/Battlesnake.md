...
Board representert internt som endimensjonelt array?

Målet er å lage kjapp kode som brukar lite plass/minne, og kanskje bruke bitwise-operasjonar for å finne ulike posisjonar på brettet, f.eks.
