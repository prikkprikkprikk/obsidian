---
Date Created: 2025-09-17T13:45
Underoppgåver:
  - "[[Search result- Endringer i master-databasen]]"
  - "[[Brukerliste i tabellformat]]"
Innboks: false
Områder:
  - "[[Jobb]]"
Prosjekt:
...
Fjerne page header-brikke, sette tittel på interaktivt søk-brikka

Fjerne col-klasser og mx-auto for webapp

søkeresultat-brikke, tabs: metode som gir klasse til UL (fjerne col-klasser)

liste: ikkje row-klasse i webapp
